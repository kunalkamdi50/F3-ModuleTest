const api_key = " cnTdLE6Ie0P6aPoJ49jKvTHJZVbFxmJOfCq1tYdf";
...
async function getcurrentImageoftheDay(date) {
  const api_url = `https://api.nasa.gov/planetary/apod?api_key=cnTdLE6Ie0P6aPoJ49jKvTHJZVbFxmJOfCq1tYdf&date=${date}`;
...
function addSearchtoHistory() {
  ...
  heading_el.textContent = "Search History";
  search_list_el.appendChild(heading_el);
